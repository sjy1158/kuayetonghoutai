    ...
    <div>
        ...
        <el-form :inline="true" :model="formInline" class="demo-form-inline" style="padding-left: 10px;padding-right: 10px;padding-top: 20px;">
            ...
            <el-form-item label="卡使用时间">
                <el-col :span="11">
                    <el-date-picker type="date" value-format="yyyy-MM-dd" placeholder="开始时间" v-model="formInline.startTime"></el-date-picker>
                </el-col>
                <el-col :span="11">
                    <el-date-picker type="date" value-format="yyyy-MM-dd" placeholder="结束时间" v-model="formInline.stopTime" style="margin-left: 20px;"></el-date-picker>
                </el-col>
            </el-form-item>
            <el-form-item>
        ...
        <!--弹出框-->
        <el-dialog title="商家提现审核" :visible.sync="dialogFormVisible">
