        ...
        <div style="width: 500px;height: auto;margin: 0 auto;margin-top: 20px!important;">
            <el-form :inline="true" :model="formInline" class="demo-form-inline">
                <el-form-item label="账号">
                    <el-input v-model="formInline.accountNumber" placeholder="请输入正确添加账号（必填）"></el-input>
                </el-form-item>
                <el-form-item label="姓名">
                    <el-input v-model="formInline.name" placeholder="请输入正确管理员姓名（必填）"></el-input>
                </el-form-item>
                <br/>
                <el-form-item label="密码">
                    <el-input type="password" v-model="formInline.password" placeholder="请输入正确密码（必填）"></el-input>
                </el-form-item>
                <br/>
                <el-form-item label="电话号">
                    <el-input v-model="formInline.phone" placeholder="请输入正确电话号码（必填）"></el-input>
                </el-form-item>
                <el-form-item label="地址">
                    <el-input v-model="formInline.address" placeholder="请输入正确完整地址（必填）"></el-input>
                </el-form-item>
                <br/>
                <el-form-item>
