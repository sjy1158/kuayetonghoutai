        ...
        <div style="width: 500px;height: auto;margin: 0 auto;margin-top: 20px!important;">
            <el-form :inline="true" :model="formInline" class="demo-form-inline">
                <el-form-item label="题目">
                    <el-input v-model="formInline.title" placeholder="请输入题目（必填）"></el-input>
                </el-form-item>
                <!--图片地址-->
                ...
                <el-form-item label="内容">
                    <textarea cols="20" style="width: 500px;padding-left: 10px;padding-top: 10px;resize: both;resize: vertical;" placeholder="(选填)" v-model="formInline.content">
