        ...
        <div style="width: 500px;height: auto;margin: 0 auto;margin-top: 20px!important;">
            <el-form :inline="true" :model="formInline" class="demo-form-inline">
                <el-form-item label="资费问题">
                    <el-input v-model="formInline.question" placeholder="请输入资费问题（必填）"></el-input>
                </el-form-item>
                <el-form-item label="资费答案">
                    <el-input v-model="formInline.answer" placeholder="请输入资费答案（必填）"></el-input>
                </el-form-item>
                <br/>
                <el-form-item>
                    <el-button type="primary" @click="producePass" style="margin-left: 200px;">立即新增</el-button>
                </el-form-item>
            </el-form>
        </div>
    </div>
