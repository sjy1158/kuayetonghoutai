        ...
        <div style="width: 500px;height: auto;margin: 0 auto;margin-top: 20px!important;">
            <el-form :inline="true" :model="formInline" class="demo-form-inline">
                <el-form-item label="商家名称">
                    <el-input v-model="formInline.name" placeholder="请输入商家名称（选填）"></el-input>
                </el-form-item>
                <el-form-item label="商家类型">
                    <el-input v-model="formInline.type" placeholder="请输入商家类型（选填）"></el-input>
                </el-form-item>
                <!--图片地址-->
                ...
                <el-form-item label="平均消费">
                    <el-input v-model="formInline.averageMoney" placeholder="请输入平均消费金额（选填）"></el-input>
                </el-form-item>
                <el-form-item label="商家详细地址">
                    <el-input v-model="formInline.address" placeholder="请输入正确商家地址（选填）"></el-input>
                </el-form-item>
                ...
                <el-form-item label="手机号">
                    <el-input v-model="formInline.phone" placeholder="请输入正确手机号（选填）"></el-input>
                </el-form-item>
                <el-form-item label="商家介绍">
                    <el-input v-model="formInline.introduce" placeholder="请输入正确商家介绍（选填）"></el-input>
                </el-form-item>
                <el-form-item label="商家公告">
                    <el-input v-model="formInline.notice" placeholder="请输入商家公告（选填）"></el-input>
                </el-form-item>
